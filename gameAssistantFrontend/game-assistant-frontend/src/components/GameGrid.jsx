...
export default function GameGrid({ games = [], onOpenGame, loading = false, error = null }) {
    return (
        <div className="grid-wrap">
            <div className="grid-surface">
                {loading ? <div className="games-grid-loading"><div className="spinner grid" /></div> :
                    error ? <div className="games-grid-error">{error}</div> : (
